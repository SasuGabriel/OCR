# -*- coding: utf-8 -*-
"""
Created on Mon Dec 14 14:24:04 2020
...
def main():
    ...
    try:
        ...
        fn = 'D:/BusuiocI/Documents/Bibliografie/Anul 2, Sem I/Statistical processing of textual data/Baza de date Analiza text/Facturi Analiza text-Ilinca/romtelecom/20201026_182941.jpg'
    ...
    while True:
        ...
        d=cv2.getTrackbarPos('d', win)
        SNR=cv2.getTrackbarPos('SNR (db)', win)
        if ch == 27:
            break
        if ch == ord(' '):
            defocus = not defocus
