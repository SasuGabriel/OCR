...
class Output_Panel(wx.Panel):
    ...
    def onDownloadFile(self, event):
        try:
            ...
            path_image="D:/BusuiocI/Documents/Bibliografie/Anul 2, Sem I/Statistical processing of textual data/python Ilinca/complete-icon.png"
            ...
            path_image="D:/BusuiocI/Documents/Bibliografie/Anul 2, Sem I/Statistical processing of textual data/python Ilinca/incomplete-icon.png"
            image = wx.Image(path_image, wx.BITMAP_TYPE_ANY)
